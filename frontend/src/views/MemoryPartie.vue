...
function afficherCartes(){
    ...
    .then((dataJSON)=>{
        console.log("afficherCartes : " + dataJSON);
        /*listeMelange.splice(0, listeMelange.length)
        dataJSON.forEach((v)=>listeMelange.push(new Paire(v.id, v.nom, v.qte)));
    */})
    .catch((error)=>console.log("afficherCartes : " + error));
}
